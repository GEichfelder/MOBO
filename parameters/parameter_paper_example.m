function [c, d, beta, alpha, delta, nD, rep_step4, gamma, color, ...
          MaxIterations, MaxFunctionEvaluations, OptimalityTolerance] = parameter_paper_example()
global n_1 n_2
...
c = [0];                 % n_2 dimensional vector, lower bound of G_tilde
d = [10];                 % n_2 dimensional vector, upper bound of G_tilde
% discretization parameter for G_tilde:
steps = 16;             % with how many steps G_tilde should be discretized (can be n_2 dimensional 
                        % or scalar)
